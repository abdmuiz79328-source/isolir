...
<title>ISOLIR WI-FI GEBY.NET</title>
...
<div class="konten">
<p>Pelanggan yang terhormat,<br/>
Kami informasikan bahwa layanan internet anda saat ini sedang terisolir atau dimatikan sementara.</p>
<p>Dimohon untuk melakukan pembayaran agar internet kembali normal.</p>
<p>Untuk menghindari ketidaknyamanan ini di kemudian hari,<br/>
dimohon untuk melakukan pembayaran sebelum tanggal jatuh tempo setiap bulannya.</p>
<p>Terima kasih TTD.<br/><span class="cpright">PERAWATAN JARINGAN</span></p>
</div>
</div>
</body>
</html><!-- EOF: BILHANET -->
